...
@Composable
fun HomeRoute(
    onNavigateToCustomerObligations: () -> Unit,
    onNavigateToDebt: () -> Unit,
    viewModel: HomeViewModel
) {
    val viewState: HomeUserDataViewState by viewModel.homeUserDataViewState.collectAsState()
    HomeScreen(
        viewState = viewState,
        onCustomerObligationsButtonClick = onNavigateToCustomerObligations,
        onDebtButtonClick = onNavigateToDebt
    )
}
